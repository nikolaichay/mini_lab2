...
var validatePassword = function validatePassword(e) {
  ...
  return e.match(regExp); //return formValidation.password !== undefined   // Это заглушка, return вероятно надо переписать
};
...
var sign_up_link_id = 'sign_up_link'; // const sign_in_form_id = 'sign_in_form'  // Пригодится

var sign_up_btn_id = 'sign_up_btn';
var sign_in_form_id = 'sign_in_form';
var sign_in_btn_id = 'sign_in_btn'; // Получаем элемент DOM-дерева по id и присваиваем значение аттрибуту oninput
